...
- Επεξεργασία προσωπικού προφίλ (όνομα, επώνυμο, τηλέφωνο, email)
...
- Προβολή όλων των ραντεβού (με φιλτράρισμα ανά κατάσταση)

**Όλοι οι συνδεδεμένοι χρήστες**
...
- Ένας απενεργοποιημένος Employee δεν μπορεί να συνδεθεί στο σύστημα.
- Η απενεργοποίηση ενός Employee (άμεσα, ή μέσω cascade από το Salon του) ακυρώνει αυτόματα τα εκκρεμή (PENDING/CONFIRMED) ραντεβού του· τα ήδη ολοκληρωμένα (COMPLETED) παραμένουν ως ιστορικό.
...
- Η διαγραφή πελάτη διαγράφει επίσης τον συνδεδεμένο λογαριασμό χρήστη (User), ώστε να μην παραμένουν «ορφανοί» λογαριασμοί σύνδεσης.
- Η αλλαγή email στο προφίλ πελάτη ή υπαλλήλου ενημερώνει ταυτόχρονα και τον λογαριασμό σύνδεσης (User), ώστε το login να παραμένει συνεπές.
- Η αλλαγή κωδικού απαιτεί σωστό τρέχοντα κωδικό (401 αν είναι λάθος).
